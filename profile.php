	...
	<div id="content">
		...
		<div class="content">
			...
			<div class="profile">
				...
				<b>Jacob Kelley</b>
				<p>Lead Developer at Dyrdek Enterprises.<br />I code and shit</p>
				<p>Los Angeles, CA</p>
				<div class="relations">
					<span><a href="#"><?PHP echo rand(650, 900); ?></a> followers</span> &middot; <span><a href="#"><?PHP echo rand(50, 100); ?></a> following</span>
				</div>
				<a href="#" class="big-button">Follow</a>
				
				<div class="tabs">
					<ul>
						<li class="active"><a href="#"><b>36</b> Posts</a></li>
						<li><a href="#"><b>78</b> Likes</a></li>
					</ul>
				</div>
			</div>
